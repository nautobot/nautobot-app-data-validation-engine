...
<p align="center">
  <img src="https://raw.githubusercontent.com/nautobot/nautobot-plugin-data-validation-engine/develop/docs/images/icon-nautobot-data-validation-engine.png" class="logo" height="200px">
  <br>
  <a href="https://github.com/nautobot/nautobot-plugin-data-validation-engine/actions"><img src="https://github.com/nautobot/nautobot-plugin-data-validation-engine/actions/workflows/ci.yml/badge.svg?branch=main"></a>
...
> Developer Note: Place the files in the `docs/images/` folder and link them using only full URLs from GitHub, for example: `![Overview](https://raw.githubusercontent.com/nautobot/nautobot-plugin-data-validation-engine/develop/docs/images/plugin-overview.png)`. This absolute static linking is required to ensure the README renders properly in GitHub, the docs site, and any other external sites like PyPI.
...
![](https://raw.githubusercontent.com/nautobot/nautobot-plugin-data-validation-engine/develop/docs/images/placeholder.png)
