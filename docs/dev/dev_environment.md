...
- `nautobot_ver`: the version of Nautobot to use as a base for any built docker containers (default: 2.1.9)
- `project_name`: the default docker compose project name (default: `nautobot-data-validation-engine`)
...
#14 naming to docker.io/nautobot-data-validation-engine/nautobot:2.1.9-py3.11 done
```
...
Creating network "nautobot_data_validation_engine_default" with the default driver
Creating volume "nautobot_data_validation_engine_postgres_data" with default driver
Creating nautobot_data_validation_engine_redis_1 ...
Creating nautobot_data_validation_engine_docs_1  ...
Creating nautobot_data_validation_engine_postgres_1 ...
Creating nautobot_data_validation_engine_postgres_1 ... done
Creating nautobot_data_validation_engine_redis_1    ... done
Creating nautobot_data_validation_engine_nautobot_1 ...
Creating nautobot_data_validation_engine_docs_1     ... done
Creating nautobot_data_validation_engine_nautobot_1 ... done
Creating nautobot_data_validation_engine_worker_1   ...
Creating nautobot_data_validation_engine_worker_1   ... done
...
ee90fbfabd77   nautobot-data-validation-engine/nautobot:2.1.9-py3.11  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_data_validation_engine_worker_1
b8adb781d013   nautobot-data-validation-engine/nautobot:2.1.9-py3.11  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_data_validation_engine_nautobot_1
d64ebd60675d   nautobot-data-validation-engine/nautobot:2.1.9-py3.11  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_data_validation_engine_docs_1
...
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   nautobot_data_validation_engine_redis_1
```
...
Stopping nautobot_data_validation_engine_worker_1   ...
Stopping nautobot_data_validation_engine_nautobot_1 ...
Stopping nautobot_data_validation_engine_docs_1     ...
Stopping nautobot_data_validation_engine_redis_1    ...
Stopping nautobot_data_validation_engine_postgres_1 ...
Stopping nautobot_data_validation_engine_worker_1   ... done
Stopping nautobot_data_validation_engine_nautobot_1 ... done
Stopping nautobot_data_validation_engine_postgres_1 ... done
Stopping nautobot_data_validation_engine_redis_1    ... done
Stopping nautobot_data_validation_engine_docs_1     ... done
Removing nautobot_data_validation_engine_worker_1   ...
Removing nautobot_data_validation_engine_nautobot_1 ...
Removing nautobot_data_validation_engine_docs_1     ...
Removing nautobot_data_validation_engine_redis_1    ...
Removing nautobot_data_validation_engine_postgres_1 ...
Removing nautobot_data_validation_engine_postgres_1 ... done
Removing nautobot_data_validation_engine_docs_1     ... done
Removing nautobot_data_validation_engine_worker_1   ... done
Removing nautobot_data_validation_engine_redis_1    ... done
Removing nautobot_data_validation_engine_nautobot_1 ... done
Removing network nautobot_data_validation_engine_default
```
...
So for example, our app is named `nautobot-data-validation-engine`, the command would most likely be `docker logs nautobot_data_validation_engine_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
Or set the `INVOKE_NAUTOBOT_DATA_VALIDATION_ENGINE_NAUTOBOT_VER` variable.
...
In the package source, there is the `nautobot_data_validation_engine/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
