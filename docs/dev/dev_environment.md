...
So for example, our plugin is named `nautobot-data-validation-engine`, the command would most likely be `docker logs nautobot_data_validation_engine_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
